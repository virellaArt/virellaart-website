...
export const marketPages: MarketPage[] = [
  ...
  },
  {
    ...
    marketName: "Россия",
    title: "Элитная мебель для России: цены и доставка | VIRELLAART",
    description:
      "Элитная мебель VIRELLAART из Стамбула для России: цены моделей в USD, комплектации, персонализация и индивидуальная проверка доставки.",
    ...
    buyerGuide: {
      eyebrow: "Цены и заказ",
      heading: "Цены и доставка мебели VIRELLAART в Россию",
      intro:
        "Актуальная стоимость зависит от выбранной модели, комплектации и подтверждённого способа доставки.",
      items: [
        {
          question: "Сколько стоит мебель VIRELLAART?",
          answer:
            "Цена каждой доступной модели указана на странице товара в USD. Перед заказом команда подтверждает выбранную комплектацию, действующую цену и возможные варианты персонализации в письменном предложении.",
        },
        {
          question: "Как рассчитывается доставка в Россию?",
          answer:
            "Стоимость и возможность доставки проверяются индивидуально по городу, объёму заказа, доступу к объекту и действующим правилам перевозки. Итоговая сумма сообщается отдельно до подтверждения заказа.",
        },
      ],
    },
  },
